            ...
            list ->
                list.stream()
                    .map(
                        measure ->
                            new ServingView(
                                Optional.ofNullable(measure.getQty()).orElse(BigDecimal.ONE),
  ...
  public static ServingView getMainServing(FoodItem dto) {
    ...
    if (dto.getBrandName() == null) {
      return new ServingView(
          BigDecimal.valueOf(Optional.ofNullable(dto.getServingQty()).orElse(1.0)),
          BigDecimal.valueOf(Optional.ofNullable(dto.getServingWeightGrams()).orElse(100.0)),
    ...
    return new ServingView(
        ...
        Optional.ofNullable(dto.getServingWeightGrams())
            ...
            .orElse(BigDecimal.valueOf(Optional.ofNullable(dto.getNfMetricQty()).orElse(100.0))),
        Optional.ofNullable(dto.getServingUnit()).orElse("g"));
  }
}
