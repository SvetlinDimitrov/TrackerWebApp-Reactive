...
public class UserModifier {
              ...
              if (Validator.validateString(dto.username(), 1, 255)) {
                ...
                return Mono.error(
                    new BadRequestException(
                        ExceptionMessages.INVALID_STRING_LENGTH_MESSAGE.getMessage()
                            + "for username."));
              }
            })
  ...
  public static Mono<UserEntity> validateAndModifyUserCreation(UserEntity user, UserCreate dto) {
    ...
    if (Validator.validateString(dto.username(), 1, 255)) {
      ...
      return Mono.error(
          new BadRequestException(
              ExceptionMessages.INVALID_STRING_LENGTH_MESSAGE.getMessage() + "for username."));
    }
    ...
    if (Validator.validateString(dto.password(), 4, 255)) {
      ...
      return Mono.error(
          new BadRequestException("Invalid password. Must be between 4 and 255 characters."));
    }
  ...
  public static Mono<UserEntity> validateAndModifyUserCreation(
      UserEntity user, UserEmailValidationCreate dto) {
