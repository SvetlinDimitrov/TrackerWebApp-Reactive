...
public class AllowedNutrientUnitUpdateValidator
    implements ConstraintValidator<AllowedNutrientUnit, NutritionUpdateRequest> {

  @Override
  public boolean isValid(NutritionUpdateRequest request, ConstraintValidatorContext context) {
