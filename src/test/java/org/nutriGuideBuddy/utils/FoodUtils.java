...
public class FoodUtils {
  ...
  public static InsertFoodDto createInsertedFood(
      String name,
      CalorieView calorieView,
      ServingView servingView,
      FoodInfoView foodInfoView,
      List<ServingView> servingViewList,
      List<NutritionView> nutritionViewList) {
    return new InsertFoodDto(
        name, calorieView, servingView, foodInfoView, servingViewList, nutritionViewList);
  }
  ...
  public static InsertFoodDto createValidInsertedFoodWithEveryPossibleNutrientView() {
    ...
    List<NutritionView> nutritionViews =
        Arrays.stream(AllowedNutrients.values())
            .map(
                data ->
                    new NutritionView(
                        data.getNutrientName(), data.getNutrientUnit(), BigDecimal.ONE))
            .toList();
  ...
  public static List<BigDecimal> getInvalidListOfInsertedCalorieAmount() {
    return List.of(BigDecimal.valueOf(-1), BigDecimal.valueOf(-9999999));
  }
  ...
  public static List<FoodInfoView> getInvalidFoodInfoViews() {
    return List.of(
        ...
        new FoodInfoView(
            ...
            "sss   asdasdasd "),
        new FoodInfoView(
            Credentials.VALID_FOOD_INFO.getValue(), Credentials.VALID_FOOD_INFO.getValue(), ". "),
        new FoodInfoView(
            Credentials.VALID_FOOD_INFO.getValue(),
            Credentials.VALID_FOOD_INFO.getValue(),
  ...
  public static List<NutritionView> getInvalidNutrientViews() {
    return List.of(
        ...
        new NutritionView(
            "VitaminC", AllowedNutrients.VitaminC.getNutrientUnit(), BigDecimal.valueOf(1)),
        ...
        new NutritionView(
            ...
            BigDecimal.valueOf(1)),
        new NutritionView(
            "CATS", AllowedNutrients.VitaminC.getNutrientUnit(), BigDecimal.valueOf(1)),
        ...
        new NutritionView(
            ...
            BigDecimal.valueOf(1)),
        new NutritionView(
            AllowedNutrients.VitaminC.getNutrientName(), "cats", BigDecimal.valueOf(1)),
        ...
        new NutritionView(
            AllowedNutrients.VitaminC.getNutrientName(), "ug", BigDecimal.valueOf(1)));
  }
