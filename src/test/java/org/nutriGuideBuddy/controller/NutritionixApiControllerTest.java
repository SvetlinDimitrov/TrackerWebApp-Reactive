...
//                    .get()
//                    .uri(
//                        "/api/food_db_api/search/common/"
//                            + Credentials.VALID_FOOD_TO_SEARCH.getValue())
//                    .header(authHeader.getName(), authHeader.getValues().get(0))
//                    .exchange()
//                    .expectStatus()
//                    .isOk()
...
//                    .get()
//                    .uri(
//                        "/api/food_db_api/search/branded/"
//                            + Credentials.VALID_FOOD_BRANDED_ID.getValue())
//                    .header(authHeader.getName(), authHeader.getValues().get(0))
//                    .exchange()
//                    .expectStatus()
//                    .isOk()
...
//
//    webTestClient.get().uri("/api/food_db_api/search").exchange().expectStatus().isUnauthorized();
//  }
//
//  @Test
...
//        .get()
//        .uri(
//            UriComponentsBuilder.fromPath("/api/food_db_api/search")
